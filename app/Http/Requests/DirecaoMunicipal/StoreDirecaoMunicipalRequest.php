...
class StoreDirecaoMunicipalRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'gabinete_provincial_id' => ['required', 'exists:gabinete_provinciais,id'],
            'nome' => ['required', 'string', 'max:255'],
            'municipio' => ['required', 'string', 'max:255', 'unique:direcao_municipais,municipio'],
            'endereco' => ['required', 'string', 'max:255'],
            'telefone' => ['required', 'string', 'max:20'],
            'email' => ['required', 'email', 'unique:direcao_municipais,email'],
