...
class UpdateHospitalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tipo' => ['sometimes', 'required', 'string', 'in:geral,municipal,provincial,centro_medico,clinica,outro'],
            'latitude' => ['sometimes', 'required', 'numeric', 'between:-90,90'],
            'longitude' => ['sometimes', 'required', 'numeric', 'between:-180,180'],
            'leitos_totais' => ['sometimes', 'required', 'integer', 'min:1'],
            'leitos_disponiveis' => ['sometimes', 'required', 'integer', 'min:0', 'lte:leitos_totais'],
